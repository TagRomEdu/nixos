...

{
  ...
  systemd.user.services."bluetooth-batteries" = {
    ...
    serviceConfig = {
      ...
      Environment = "XDG_RUNTIME_DIR=/run/user/${config.users.users.tre.uid}";
      Environment = "DBUS_SESSION_BUS_ADDRESS=unix:path=/run/user/${config.users.users.tre.uid}/bus";
    };
  };
...
#    loader.systemd-boot.enable = true;
    ...
    loader.grub = {
      ...
      efiSupport = true;
      device = "nodev";
      theme = lib.mkForce ./grub/grub-themes/hollow-knight-grub-theme/hollow-grub;
