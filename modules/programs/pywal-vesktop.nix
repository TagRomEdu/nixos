...
{
  # Ensure Pywal template for Vencord exists
  home.file.".config/wal/templates/colors-discord.css".text = ''
    /**
  ...
  # Symlink the generated theme to Vesktop's themes directory
  home.file.".config/vesktop/themes/pywal-vencord.theme.css".source =
    config.lib.file.mkOutOfStoreSymlink "${config.xdg.cacheHome}/wal/colors-discord.css";
}
